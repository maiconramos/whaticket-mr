    ...
    return (
        <div className={classes.root}>
            <Container>
                ...
                <ul>
                    <li className={classes.text}>Para pegar o token da API, vá em configurações que seu token estará la, sem ele não será possível enviar mensagens.</li>
                ...
                <p className={classes.textP}><b>Body: </b>"number": "5599999999999", "medias": "aqui vai sua mídia", "body": "Enviado via api"</p>
            </Container>
        </div>
    );
};
